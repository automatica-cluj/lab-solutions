...
public interface ControllerInterface {
     ...
     * If {@link isp.lab7.safehome.ControllerInterface#MASTER_KEY} is used as input value, number of retries will be reset to 0 and door will be locked / unlocked based on its current state
     *
     * @param pin - pin value
